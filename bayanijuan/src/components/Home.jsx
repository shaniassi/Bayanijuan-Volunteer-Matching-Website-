...
const Home = () => {
  return (
    <div className='min-h-[750px] mt-16 sm:mt-16 md:mt-20 lg:mt-3 sm:min-h-[800px] flex flex-col-reverse justify-center lg:flex-row lg:justify-between items-center lg:px-32 px-5 gap-10 bg-cream text-blue mb-2'>
        <div className='w-ful lg:w-2/4 space-y-4 mt-5 lg:mt-0'>
            ...
            <p className='text-xl font-body mt-5 mb-10 py-3 sm:text-2xl'>Discover meaningful volunteer opportunities tailored to your interests and skills with our intuitive volunteer matching platform. Join a community dedicated to connecting passionate individuals with impactful causes worldwide.</p>
