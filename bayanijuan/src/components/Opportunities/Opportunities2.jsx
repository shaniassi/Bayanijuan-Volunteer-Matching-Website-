...
const Opportunities2 = () => {
    ...
    return (
        <div className='flex flex-col min-h-[500px] items-center bg-cream p-10'>
            <div className='flex flex-wrap justify-center gap-8'>
                {categories.map((category, index) => (
                    <div key={index} className='bg-sun shadow-lg rounded-lg p-6 w-full md:w-[300px] flex flex-col items-center text-center h-[330px]'>
